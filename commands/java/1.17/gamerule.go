...
const (
	...
	DoPatrolSpawning           gameRuleBoolName = "doPatrolSpawning"
	DoTileDrops                gameRuleBoolName = "doTileDrops"
	DoTraderSpawning           gameRuleBoolName = "doTraderSpawning"
	...
	ForgiveDeadPlayers         gameRuleBoolName = "forgiveDeadPlayers"
	FreezeDamage               gameRuleBoolName = "freezeDamage" // new
	...
	UniversalAnger             gameRuleBoolName = "universalAnger"
)
...
const (
	...
	PlayersSleepingPercentage gameRuleIntName = "playersSleepingPercentage" // new
